...
extension Notification.Name {
    ...
    static let getPlaylistsCallbackError = Notification.Name("getPlaylistsCallbackError")
    static let getSongsCallbackError = Notification.Name("getSongsCallbackError")
}
